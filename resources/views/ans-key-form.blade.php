                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-trigger name="institute_id"
                                            id="institute_id" placeholder="Search"></select>
                                    </div>
                                </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="mb-3">
                                    <label for="choices-single-default" class="form-label font-size-13 text-muted">Enater Test Name</label>
                                    <input id="test_name" name="test_name" placeholder="Enter Test Name" type="text" class="form-control" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                        <div class="col-md-3">
                                            <div class="mt-lg-0">
                                                <label class="form-label b-alfabat" for="form-sm-input">A &nbsp;B &nbsp;C&nbsp; D</label>
                                               @for($fc = 1; $fc <= 25; $fc++)
                                            ...
                                            <div class="mt-lg-0">
                                                ...
                                                @for($fc = 51; $fc <= 75; $fc++)
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <div class="form-check form-check-right mb-3">
                                                            <input class="form-check-input ans{{$fc}}" placeholder="A" value="1" type="radio" name="A{{$fc}}"
                                                                   id="ans{{$fc}}">
                                                        </div>
                                                        <div class="form-check form-check-right mb-3">
                                                            <input class="form-check-input ans{{$fc}}" value="2" type="radio" name="A{{$fc}}"

!function (t, e) {
    ...
    function w(t, e, n) {
        ...
        if (arguments.length > 2 && (s.children = arguments.length > 3 ? l.call(arguments, 2) : n), "function" == typeof t && null != t.defaultProps) for (o in t.defaultProps) void 0 === s[o] && (s[o] = t.defaultProps[o]);
    ...
    function F(t, e, n, r, i, o, s, a, u, l) {
        var c, p, h, f, d, _, v, y = r && r.__k || g, b = y.length;
        for (n.__k = [], c = 0; c < e.length; c++) if (null != (f = n.__k[c] = null == (f = e[c]) || "boolean" == typeof f ? null : "string" == typeof f || "number" == typeof f || "bigint" == typeof f ? P(null, f, null, null, f) : Array.isArray(f) ? P(S, {children: f}, null, null, null) : f.__b > 0 ? P(f.type, f.props, f.key, null, f.__v) : f)) {
    ...
    function U(t, e, n, r, i, o, s, a, u) {
        ...
        try {
            t:if ("function" == typeof x) {
                ...
                if (p.context = b, p.props = g, p.__v = e, p.__P = t, w = c.__r, P = 0, "prototype" in x && x.prototype.render) p.state = p.__s, p.__d = !1, w && w(e), l = p.render(p.props, p.state, p.context); else do {
    ...
    function M(t, e, n, r, i, o, s, a) {
        var u, c, p, h = n.props, f = e.props, d = e.type, _ = 0;
        if ("svg" === d && (i = !0), null != o) for (; _ < o.length; _++) if ((u = o[_]) && "setAttribute" in u == !!d && (d ? u.localName === d : 3 === u.nodeType)) {
            t = u, o[_] = null;
            break
        }
        if (null == t) {
        ...
        if (null === d) h === f || a && t.data === f || (t.data = f); else {
            if (o = o && l.call(t.childNodes), c = (h = n.props || m).dangerouslySetInnerHTML, p = f.dangerouslySetInnerHTML, !a) {
                if (null != o) for (h = {}, _ = 0; _ < t.attributes.length; _++) h[t.attributes[_].name] = t.attributes[_].value;
            ...
            }(t, f, h, i, a), p) e.__k = []; else if (_ = e.props.children, F(t, Array.isArray(_) ? _ : [_], e, n, r, i && "foreignObject" !== d, o, s, o ? o[0] : n.__k && C(n, 0), a), null != o) for (_ = o.length; _--;) null != o[_] && b(o[_]);
    ...
    var ft = function () {
        ...
        return i(e, t), e.prototype.render = function () {
            ...
            if (this.props.pluginId) {
                ...
                return e ? w(S, {}, w(e.component, r({plugin: e}, e.props, this.props.props))) : null
            }
            return void 0 !== this.props.position ? w(S, {}, this.config.plugin.list(this.props.position).map((function (e) {
                return w(e.component, r({plugin: e}, e.props, t.props.props))
            }))) : null
        }, e
    }(X), _t = function (t) {
        function e(e, n) {
        ...
        return n.componentWillUnmount = function () {
            ...
            }), w("div", {className: rt(it("search", this.config.className.search))}, w("input", {
                type: "search",
    ...
    var St = function (e) {
            ...
            return s.adjustWidth = function (t) {
                ...
                for (var e, n = new o, r = u(t); !(e = r()).done;) {
                    var i = e.value;
                    if ("string" == typeof i || h(i)) n.columns.push({name: i}); else if ("object" == typeof i) {
                        var s = i;
    ...
    var At, Lt = function (t) {
        ...
        return n.assign = function (t) {
            ...
            var i = new e(n);
            return i._userConfig = n, "boolean" == typeof n.sort && n.sort && i.assign({sort: {multiColumn: !0}}), i.assign({header: St.fromUserConfig(i)}), i.assign({storage: Et.createFromUserConfig(n)}), i.assign({pipeline: Ot.createFromConfig(i)}), i.assign({translator: new G(n.language)}), i.plugin.add({
                id: "search",
    ...
    var Wt, Bt, zt, qt, Vt = function (t) {
        ...
        return n.getColumn = function (t) {
            ...
            return this.props.children ? this.props.children : w(S, null, this.props.row.cells.map((function (e, n) {
                var r = t.getColumn(n);
                return r && r.hidden ? null : w(Vt, {key: e.id, cell: e, row: t.props.row, column: r})
            })))
        }, n.render = function () {
            return w("tr", {
        ...
        return n.headerLength = function () {
            ...
            var t = this;
            return w("tbody", {className: it(rt("tbody"), this.config.className.tbody)}, this.props.data && this.props.data.rows.map((function (e) {
        ...
        return n.componentWillUnmount = function () {
            ...
            return n.length > 0 ? e = n[0] : (this.updateSortProcessorFn = this.updateSortProcessor.bind(this), this.store.on("updated", this.updateSortProcessorFn), e = t === Y.ServerSort ? new Jt(r({columns: this.store.state}, this.config.sort.server)) : new Kt({columns: this.store.state}), this.config.pipeline.register(e)), e
        ...
        return n.isSortable = function () {
            ...
            }, this.getCustomAttributes(), t), w("div", {className: rt("th", "content")}, this.content()), this.isSortable() && w(Qt, r({
                ref: this.sortRef,
        ...
        return n.renderColumn = function (t, e, n, r) {
            ...
            return w(ee, {column: t, index: n, colSpan: i.colSpan, rowSpan: i.rowSpan})
        ...
        return i(e, t), e.prototype.render = function () {
            ...
            }, w(ne, {header: this.props.header}), w($t, {
        ...
        return o.componentDidMount = function () {
            ...
            }, w(dt, {position: t.PluginPosition.Header})) : null
        }, n
    }(X), oe = function (e) {
        function n(t, n) {
            var r;
        ...
        return o.componentDidMount = function () {
            ...
            }, w(dt, {position: t.PluginPosition.Footer})) : null
        }, n
    }(X), se = function (t) {
        function e(e, n) {
            var r;
            return (r = t.call(this, e, n) || this).configContext = void 0, r.processPipelineFn = void 0, r.configContext = function (t, e) {
                var n = {
                    __c: e = "__cC" + _++, __: null, Consumer: function (t, e) {
                        return t.children(e)
                    }, Provider: function (t) {
                        var n, r;
            ...
            }(), r.state = {status: At.Loading, header: e.header, data: null}, r
        }
        ...
        return n.processPipeline = function () {
            try {
                var t = this;
                t.props.config.eventEmitter.emit("beforeLoad"), t.setState({status: At.Loading});
                var e = function (e, n) {
                    try {
                        var r = Promise.resolve(t.props.pipeline.process()).then((function (e) {
                            t.setState({data: e, status: At.Loaded}), t.props.config.eventEmitter.emit("load", e)
                        }))
                    } catch (t) {
                        return n(t)
                    }
            ...
            e.status != At.Rendered && this.state.status == At.Loaded && (this.setState({status: At.Rendered}), this.props.config.eventEmitter.emit("ready"))
        }, n.render = function () {
            return w(this.configContext.Provider, {value: this.props.config}, w("div", {
                role: "complementary",
            ...
            }, this.state.status === At.Loading && w("div", {className: rt("loading-bar")}), w(ie, null), w("div", {
            ...
            })), w(oe, null), w("div", {ref: this.props.config.tempRef, id: "gridjs-temp", className: rt("temp")})))
        }, e
    }(X), ae = function (t) {
        function e(e) {
            var n;
